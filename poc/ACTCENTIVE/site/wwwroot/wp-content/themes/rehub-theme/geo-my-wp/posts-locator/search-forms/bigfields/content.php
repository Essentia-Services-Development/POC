<?php 
/**
 * Posts Locator "Big fields" search form template file. 
 * 
 ...
 * Instead you can copy-paste this template ( the "Big fields" folder contains this file and the "css" folder ) 
 * into the theme's or child theme's folder of your site and apply your changes from there. 
 * 
 * The template folder will need to be placed under:
 * your-theme's-or-child-theme's-folder/geo-my-wp/post-locator/search-forms/
 * 
 * Once the template folder is in the theme's folder you will be able to choose it when editing the Posts locator form.
 * It will show in the "Search results" dropdown menu as "Custom: Big fields".
 */
?>
<?php do_action( 'gmw_before_search_form_template', $gmw ); ?>

<div class="gmw-form-wrapper <?php echo esc_attr( $gmw['prefix'] ); ?> gmw-pt-form-wrapper gmw-pt-horizontal-big-form-wrapper">
