<?php 
/**
 * Members Locator "horizontal xprofiles" search form template file. 
 * 
 ...
 * Instead you can copy-paste this template ( the "horizontal xprofiles" folder contains this file and the "css" folder ) 
 ...
 * It will show in the "Search results" dropdown menu as "Custom: horizontal xprofiles".
 */
?>
<?php do_action( 'gmw_before_search_form_template', $gmw ); ?>

<div class="gmw-form-wrapper <?php echo esc_attr( $gmw['prefix'] ); ?> gmw-fl-form-wrapper gmw-fl-horx-custom-form-wrapper">
