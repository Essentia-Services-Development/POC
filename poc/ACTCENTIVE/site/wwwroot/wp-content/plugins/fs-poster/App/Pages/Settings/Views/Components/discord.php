...
<div class="fsp-settings-row">
    <div class="fsp-settings-col">
        ...
        <div class="fsp-settings-label-subtext"><?php echo fsp__( 'Discord limits a message length to a maximum of 2000 characters.  By enabling the option, the first 2000 characters of your custom message will be shared; otherwise, the message won\'t be shared because of the limit.' ); ?></div>
    </div>
    <div class="fsp-settings-col">
        <div class="fsp-toggle">
            <input type="checkbox" name="fs_discord_auto_cut_message" class="fsp-toggle-checkbox" id="fs_discord_auto_cut_message"<?php echo Helper::getOption( 'discord_auto_cut_message', '1' ) ? ' checked' : ''; ?>>
            <label class="fsp-toggle-label" for="fs_discord_auto_cut_message"></label>
        </div>
    </div>
</div>
