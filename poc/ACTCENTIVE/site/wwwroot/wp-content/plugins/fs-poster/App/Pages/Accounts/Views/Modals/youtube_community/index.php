...
<div>
	<?php foreach ( $fsp_params[ 'accounts_list' ] as $account_info )
	{
		...
		<div class="fsp-account">
			<div class="fsp-card fsp-account-item" data-id="<?php echo $account_info[ 'id' ]; ?>" data-type="account" data-active="<?php echo isset( $account_info[ 'is_active' ] ) && ! empty( $account_info[ 'is_active' ] ) ? 1 : 0; ?>" data-hidden="<?php echo $account_info[ 'is_hidden' ]; ?>" data-failed="<?php echo $account_info[ 'status' ] === 'error' ? 1 : 0; ?>" data-cookie="1">
...
<script>
    jQuery( document ).ready( function () {
        FSPoster.load_script( '<?php echo Pages::asset( 'Accounts', 'js/fsp-accounts-youtube-community.js' ); ?>', false );
    } );

    FSPObject.modalURL      = 'add_youtube_community_account';
    FSPObject.editModalURL  = 'edit_youtube_community_account';
