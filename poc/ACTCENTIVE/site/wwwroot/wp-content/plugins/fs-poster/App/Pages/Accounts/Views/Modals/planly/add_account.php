    ...
    <div class="fsp-modal-step">
        <div class="fsp-form-group">
            <label class="fsp-is-jb">
                ...
                <a href="https://www.fs-poster.com/documentation/how-to-auto-publish-and-schedule-wordpress-posts-to-tiktok" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
