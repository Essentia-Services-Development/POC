...
<div class="fsp-modal-header">
	<div class="fsp-modal-title">
		...
		<div class="fsp-modal-title-text">
			<?php echo fsp__( 'Add a Mastodon account' ); ?>
		</div>
	</div>
	...
	<div id="fspCustomAppContainer" class="fsp-form-group fsp-hide">
		<div class="fsp-form-group">
			<label class="fsp-is-jb">
				...
				<a href="https://www.fs-poster.com/documentation/fs-poster-auto-publish-wordpress-posts-to-mastodon" target="_blank" class="fsp-tooltip" data-title="<?php echo fsp__( 'How to?' ); ?>">
			...
			<select class="fsp-form-select" id="fspModalAppSelector">
				...
				{ ?>
					<option disabled><?php echo fsp__( 'There isn\'t a Mastodon App!' ); ?></option>
				<?php } ?>
			</select>
		</div>
	</div>
...
<script>
	jQuery( document ).ready( function () {
		FSPoster.load_script( '<?php echo Pages::asset( 'Accounts', 'js/fsp-accounts-mastodon.js' ); ?>' );
	} );

	fspConfig.standartAppURL = '<?php echo /*Helper::standartAppRedirectURL( 'mastodon' );*/ "" ?>';
</script>
