	...
	private function generate_sidebar_CSS_V2( $kb_config ) {
		...
		<style><?php
			...
			#epkb-sidebar-container-v2 {
				background-color: <?php echo $container_background_Color.';'; ?> border-color:<?php echo $container_border_Color.';'; ?> border-width: <?php echo $container_border_Width.'px;'; ?> border-radius:<?php echo $container_border_Radius.'px;'; ?> <?php if ( $this->kb_config['sidebar_side_bar_height_mode'] == 'side_bar_fixed_height' ) { ?> overflow: auto;
				max-height: <?php echo $sidebar_side_bar_height.'px;'; ?> <?php } ?>
			}

			/* Category Heading */
			#epkb-sidebar-container-v2 .epkb-sidebar__cat__top-cat__heading-container {
				text-align: <?php echo $catHeading_alignment.';'; ?>
                border-width:<?php echo $catHeading_dividerThickness.'px;'; ?>
                padding-top: <?php echo $catHeading_paddingTop.'px;'; ?>
                padding-bottom:<?php echo $catHeading_paddingBottom.'px;'; ?>
                padding-left: <?php echo $catHeading_paddingLeft.'px;'; ?>
                padding-right:<?php echo $catHeading_paddingRight.'px;'; ?>
                border-bottom-color: <?php echo $catHeading_dividerColor.';'; ?>
                background-color:<?php echo $catHeading_BackgroundColor.';'; ?>
			}			<?php
			...
			#epkb-sidebar-container-v2 .epkb-sidebar__cat__top-cat:first-child .epkb-sidebar__cat__top-cat__heading-container {
				border-top-left-radius: <?php echo $container_border_Radius.'px;'; ?> border-top-right-radius:<?php echo $container_border_Radius.'px;'; ?>
			}

			/* Last Category Heading */
			#epkb-sidebar-container-v2 .epkb-sidebar__cat__top-cat:last-child .epkb-sidebar__cat__top-cat__heading-container {
				border-bottom-left-radius: <?php echo $container_border_Radius.'px;'; ?> border-bottom-right-radius:<?php echo $container_border_Radius.'px;'; ?>
			}
			...
			#epkb-sidebar-container-v2 .epkb-sidebar__heading__inner .epkb-sidebar__heading__inner__name > a {
				color: <?php echo $catHeadingInner_fontColor.';'; ?> text-align:<?php echo $catHeadingInner_TextAlignment.';'; ?>
			}

			#epkb-sidebar-container-v2 .epkb-sidebar__heading__inner .epkb-sidebar__heading__inner__desc p {
				color: <?php echo $catHeadingInner_DescColor.';'; ?> text-align:<?php echo $catHeadingInner_TextAlignment.';'; ?>
			}

			/* Category Body */
			#epkb-sidebar-container-v2 .epkb-sidebar__cat__top-cat__body-container {
				padding-top: <?php echo $catBodyContainer_paddingTop.'px;'; ?> padding-bottom:<?php echo $catBodyContainer_paddingBottom.'px;'; ?> padding-left: <?php echo $catBodyContainer_paddingLeft.'px;'; ?> padding-right:<?php echo $catBodyContainer_paddingRight.'px;';

				if ( $this->kb_config['sidebar_section_box_height_mode'] == 'section_min_height' ) { ?> min-height: <?php echo $catBodyContainer_BodyHeight.';';
				} else if ( $this->kb_config['sidebar_section_box_height_mode'] == 'section_fixed_height' ) { ?> overflow: auto;
				height: <?php echo $catBodyContainer_BodyHeight.';';
				}	?>
			...
			#epkb-sidebar-container-v2 .epkb-sidebar__cat__top-cat__body-container .epkb-sidebar__body__sub-cat {
				padding-left: <?php echo $catBodySubCatArticleMargin.'px;'; ?>
			}

			/* Article */
			.epkb-sidebar__cat__top-cat__body-container .epkb-articles .eckb-article-title {
				color: <?php echo $article_Font_color.' !important;'; ?>
			}

			.epkb-sidebar__cat__top-cat__body-container .epkb-articles .active {
				color: <?php echo $article_Font_Active_color.';'; ?> background-color:<?php echo $article_Font_BackgroundColor.';'; ?>
			}

			.epkb-sidebar__cat__top-cat__body-container .epkb-articles .active .eckb-article-title {
				color: <?php echo $article_Font_Active_color.' !important;'; ?>
			}   <?php
