...
class EPKB_ML_Articles_List {
	...
	public function display_articles_list() { ?>
		...
		<div id="epkb-ml-article-list-<?php echo strtolower( $this->kb_config['kb_main_page_layout'] ); ?>-layout" class="epkb-ml-article-list-container">   <?php
			...
			if ( ! empty( $this->kb_config['ml_articles_list_title_text'] ) ) { ?>
	...
	public static function get_inline_styles( $kb_config ) {
		...
		if ( ! empty( $kb_config['general_typography']['font-family'] ) ) {
			$output .= '
			#epkb-ml__module-articles-list .epkb-ml-articles-list__title {
		...
		$output .= '
		    #epkb-ml__module-articles-list .epkb-ml-articles-list li a {
