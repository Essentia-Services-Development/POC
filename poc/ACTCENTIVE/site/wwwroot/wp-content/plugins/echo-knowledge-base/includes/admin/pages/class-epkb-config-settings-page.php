	...
	private function show_custom_display_fields( $setting_name, $show_included=false ) {
		...
		if ( $setting_name == 'typography_message' ) {  ?>
			<p><?php
				...
				<a href="<?php echo add_query_arg( array( 'action' => 'epkb_load_editor' ), EPKB_KB_Handler::get_first_kb_main_page_url( $this->kb_config ) ); ?>" data-open-editor-link="<?php echo EPKB_Core_Utilities::is_kb_flag( 'editor_backend_mode' ) ? 'back' : 'front'; ?>"
	...
	private function get_contents_configs() {
		...
		if ( ! EPKB_Utilities::is_new_user( '11.30.0' ) || ! $this->is_modular_main_page ) {
			$contents_configs['main-page'] = array(
				array(
					'title'         => __( 'Try Our New Modular Main Page', 'echo-knowledge-base' ),
