<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php esc_html_e('Import', 'rehub-framework') ?>
		</label>
		<div class="description">
			<p><?php esc_html_e('Import Options', 'rehub-framework') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php esc_html_e('Import', 'rehub-framework') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php esc_html_e('Export', 'rehub-framework') ?>
		</label>
		<div class="description">
			<p><?php esc_html_e('Export Options', 'rehub-framework') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php esc_html_e('Export', 'rehub-framework') ?>" />
				<span style="margin-left: 10px;">
