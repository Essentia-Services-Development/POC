=== ImportWP PRO – Export and Import CSV and XML files to WordPress ===
...
* ADD - Try to resume stalled importers.
* FIX - ACF returns field name instead of field id when using the filter 'iwp/custom_field_key'.

= 2.9.4 =

* ADD - Add license form on wp admin plugins page to recieve automatic plugin updates.

= 2.9.3 =

* ADD - add acf and acf pro to compat whitelist.
* FIX - Fix updater class to not throw warnings.
* FIX - Fix cron runner to handle the timeout status better.

= 2.9.2 =

* ADD - Add custom fields help/documentation link to field group.
...
* ADD - Add Custom fields to ImportWP new Permission field Interface.
