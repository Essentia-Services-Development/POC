 ...
 *
 */
if ( ! class_exists( 'PVFWOF_Field_sortable' ) ) {
  class PVFWOF_Field_sortable extends PVFWOF_Fields {
    ...
    public function render() {
      ...
      echo '<div class="pvfwof-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="pvfwof-sortable-item">';

          echo '<div class="pvfwof-sortable-content">';
          ...
          PVFWOF::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="pvfwof-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
