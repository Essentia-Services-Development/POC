 ...
 *
 */
if ( ! class_exists( 'PVFWOF_Field_textarea' ) ) {
  class PVFWOF_Field_textarea extends PVFWOF_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( PVFWOF::$shortcode_instances ) ) ? PVFWOF::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary pvfwof-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
