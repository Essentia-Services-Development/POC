 ...
 *
 */
if ( ! class_exists( 'PVFWOF_Field_color' ) ) {
  class PVFWOF_Field_color extends PVFWOF_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="pvfwof-color"'. $default_attr . $this->field_attributes() .'/>';
