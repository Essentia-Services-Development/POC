...
* MIT License
*
* Customized by Pvfwof
*
*/
(function($) {

  function PVFWOFAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  PVFWOFAjaxChosen.prototype.init = function() {
  ...
  PVFWOFAjaxChosen.prototype.events = function() {
  ...
  PVFWOFAjaxChosen.prototype.search_field_focused = function() {
  ...
  PVFWOFAjaxChosen.prototype.search_welcome_message = function() {
  ...
  PVFWOFAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('pvfwof-chosen', _this.options.data).done( function( response ) {
  ...
  PVFWOFAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.pvfwof-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.PVFWOFChosenOrder($hidden_value, true);
  ...
  $.fn.PVFWOFAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new PVFWOFAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, PVFWOFAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  PVFWOFAbstractChosenOrder = (function() {

    function PVFWOFAbstractChosenOrder() {}

    PVFWOFAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    PVFWOFAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    PVFWOFAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    PVFWOFAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    PVFWOFAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    PVFWOFAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    PVFWOFAbstractChosenOrder.PVFWOFChosenOrder = function(select, order, force) {
    ...
    return PVFWOFAbstractChosenOrder;
  ...
  $.fn.extend({
    PVFWOFChosenOrder: function(order, force) {
      return _PVFWOFChosenOrder.PVFWOFChosenOrder(this, order, force);
    }
  });

  this._PVFWOFChosenOrder = (function(_super) {
    __extends(_PVFWOFChosenOrder, _super);

    function _PVFWOFChosenOrder() {
      _ref = _PVFWOFChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _PVFWOFChosenOrder.relAttributeName = 'data-option-array-index';

    _PVFWOFChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _PVFWOFChosenOrder.getDOMElement = function(element) {
    ...
    _PVFWOFChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _PVFWOFChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _PVFWOFChosenOrder;

  })(PVFWOFAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('pvfwof-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('pvfwof-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Pvfwof: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Pvfwof: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectPVFWOF = FormSerializer.serializeObject;
    $.fn.serializeJSONPVFWOF   = FormSerializer.serializeJSON;
  }
