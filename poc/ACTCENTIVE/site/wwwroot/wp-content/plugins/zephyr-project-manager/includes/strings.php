...
$strings = array(
	...
	'sent' => __('Sent', 'zephyr-project-manager'),
	'comment' => __('Comment', 'zephyr-project-manager'),
	'select_multiple' => __('Select Multiple', 'zephyr-project-manager'),
	...
	'archive' => __('Archive', 'zephyr-project-manager'),
	'unarchive' => __('Unarchive', 'zephyr-project-manager'),
	'nothing_selected' => __('Nothing selected', 'zephyr-project-manager'),
	'create_task_or_select_existing' => __('Create New Task or Select Existing', 'zephyr-project-manager'),
	'archive_tasks' => __('Archive Tasks', 'zephyr-project-manager'),
	'delete_tasks' => __('Delete Tasks', 'zephyr-project-manager'),
	'create_subtask' => __('Create Subtask', 'zephyr-project-manager'),
	'create_task' => __('Create Task', 'zephyr-project-manager'),
	'subtask_saved' => __('Subtask Saved', 'zephyr-project-manager'),
	'subtask_deleted' => __('Subtask Deleted', 'zephyr-project-manager'),
	'creating' => __('Creating...', 'zephyr-project-manager'),
	...
	'no_projects_created_final' => __('No projects created yet.', 'zephyr-project-manager'),
	...
	'task_archived' => __('Task Archived', 'zephyr-project-manager'),
	'task_unarchived' => __('Task Unarchived', 'zephyr-project-manager'),
	...
	'select_project_first' => __('Please select a project first.', 'zephyr-project-manager'),
	...
	'message_sent' => __('Message sent', 'zephyr-project-manager'),
	'downloading' => __('Downloading...', 'zephyr-project-manager'),
	'enterText' => __('Enter Text', 'zephyr-project-manager'),
	'confirm' => __('Confirm', 'zephyr-project-manager'),
	'automatically_update_dates' => __('Automatically update start and due dates', 'zephyr-project-manager'),
	'button_text' => array(
