<div class="ps-settings__bar ps-clearfix">
	<div class="ps-settings__nav">
		<button type="button" class="ps-js-field-expand-all">
			<i class="fa fa-expand"></i> <span><?php echo __('Expand All', 'peepso-core'); ?></span>
		</button>
		<button type="button" class="ps-js-field-collapse-all">
	...
	<div class="ps-settings__nav ps-settings__nav--right ps-dropdown">
		<button type="button" class="btn-primary ps-js-field-new">
