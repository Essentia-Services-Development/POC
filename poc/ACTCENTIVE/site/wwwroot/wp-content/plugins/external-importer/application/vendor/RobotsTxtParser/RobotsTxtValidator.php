...
namespace ExternalImporter\application\vendor\RobotsTxtParser;

defined('\ABSPATH') || exit;
/**
 *  Modified version of RobotsTxtValidator with minor code changes by support@keywordrush.com
 *  Original work Copyright (c) 2014 Eugene, licensed under MIT
 */
