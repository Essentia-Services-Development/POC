	  ...
	  for (var i in icons) {
		  $list.append('<li data-icon="'+icons[i]+'"><a href="#" title="'+icons[i]+'"><span class="'+options[0]+' '+options[1]+'-'+icons[i]+'"></span></a></li>');
			...
			function createPopup($button) {
				...
				$control.html('<p>Select Font: <select><option value="dashicons">Dashicons</option><option value="lni">Line Icons</option><option value="fas">Font Awesome Solid</option><option value="fab">Font Awesome Brand</option></select></p>'+
