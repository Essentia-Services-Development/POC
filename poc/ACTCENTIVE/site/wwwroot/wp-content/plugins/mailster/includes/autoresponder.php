...
$mailster_autoresponder_info['units']   = apply_filters( 'mailster_autoresponder_units', $mailster_autoresponder_info['units'] );
$mailster_autoresponder_info['actions'] = apply_filters( 'mailster_autoresponder_actions', $mailster_autoresponder_info['actions'] );
