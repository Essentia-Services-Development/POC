<?php
/**
 * Log request and response during the share counter update process
 * 
 * @author appscreo
 * @package EasySocialShareButtons
 * @since 8.2
 */
class ESSB_Logger_ShareCounter_Update {
    const LOG_NAME = 'essb_log_sharecounter';
    const MAX_LOG_ENTRIES = 99;    
    
    public static function log($network, $url, $request, $response) {
        $log = array(
